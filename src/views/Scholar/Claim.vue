...
<div id="Claim">
  ...
  <v-stepper v-model="e1">
    ...
    <v-stepper-items >
      ...
      <v-stepper-content step="1" color="blue-grey lighten-5">
        ...
        >
        <h3 style="margin-bottom:20px" >您可以跟踪自己文章的引用情况。个人学术档案还会出现在学术搜索结果中</h3>
        <h4 style="display: inline-block; margin-right: 45px">{{email}}</h4>
        <v-btn color="primary" outlined small style="display: inline-block" width="100px">切换账户</v-btn>
        <div class="card1">
   <v-form
    ref="form"
    v-model="valid"
    ...
    <v-list two-line class="liststyle">
      ...
      >
        <template v-for="(item, index) in grouplist">
          <v-list-item :key="item.title" style="width:600px">
  ...
  <!-- button panel -->
      <v-row  justify="space-around">          
        ...
        <v-btn style="margin:100px" color="primary"  @click="e1=3">继续</v-btn>
    </v-row>
      </v-tab-item>
    </v-tabs-items>
  </v-card>
