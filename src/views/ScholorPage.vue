<template>
    <v-container id="page">
                    ...
                    <v-row no-gutters>
                        ...
                        <v-col class="ml-2">
                            ...
                            <div class="intro ma-1 text-body-1">
                                <p class="text-left pa-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                                    Placeat tempora eligendi nihil ex velit ipsam fuga dolorum molestias doloribus. 
                                    Voluptas saepe nemo ad pariatur doloribus nesciunt consequuntur a, quam fuga!
                                </p>
                            </div>
                        </v-col>
                    </v-row>
                ...
                <v-row>
                    ...
                    <v-col>
                        ...
                        <v-row class="mt-2" no-gutters>
                            <v-col v-for="item in MainField" :key="index" cols="6" class="pa-auto">
                                <p> {{ item.title }} </p>
                            </v-col>
                        </v-row>
                    </v-col>
        ...
        <v-row class="mx-12">
            <v-col cols="8">
                <v-card elevation="7">
                    <v-card-title class="text-left">论文共{{Papers.length}}篇</v-card-title>
                    <v-card-subtitle>
                        <v-row dense>
                            <v-col cols="12">
                                <v-btn-toggle
                ...
                <v-row>
                    <v-col cols="12" v-for="paper in Papers" :key="index">
                        <PaperShowVue
                        :name="paper.name"
